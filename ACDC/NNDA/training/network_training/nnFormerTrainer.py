...
from nnformer.training.network_training.acdc.unetr_pp_acdc  import UNETR_PP #这是我自己添加的
...
class nnFormerTrainer(NetworkTrainer):
    ...
    def initialize(self, training=True, force_load_plans=False):
        ...
        # assert isinstance(self.network, (SegmentationNetwork, nn.DataParallel)) #我忘了原来有没有注释的呢
    ...
    def initialize_network(self):
        ...
        self.network = Generic_UNet(self.num_input_channels, self.base_num_features, self.num_classes, net_numpool,
                                    ...
                                    self.net_num_pool_op_kernel_sizes, self.net_conv_kernel_sizes, False, True, True) # 这个原来没有注释

        # self.network = UNETR_PP(in_channels=1, out_channels=4, img_size=(16,160,160), feature_size=16, num_heads=4,
    ...
    def predict_preprocessed_data_return_seg_and_softmax(self, data: np.ndarray, do_mirroring: bool = True,
        ...
        # assert isinstance(self.network, tuple(valid)) #自己注释的
