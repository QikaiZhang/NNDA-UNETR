...
from nnformer.training.network_training.acdc.lion_optimizer import Lion
from nnformer.training.network_training.acdc.lr_scheduler import LinearWarmupCosineAnnealingLR
...
class nnFormerTrainerV2(nnFormerTrainer):
    ...
    def initialize_optimizer_and_scheduler(self):
        ...
        # self.optimizer = Lion(self.network.parameters(), lr=self.initial_lr,weight_decay=self.weight_decay)
        # self.lr_scheduler = LinearWarmupCosineAnnealingLR(self.optimizer,warmup_epochs=200,max_epochs=self.max_num_epochs)
