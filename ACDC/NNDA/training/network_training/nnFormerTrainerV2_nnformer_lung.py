...
from nnformer.training.network_training.lung.unetr_pp_lung  import UNETR_PP
from nnformer.training.network_training.nnFormerTrainer import nnFormerTrainer
    
class nnFormerTrainerV2_nnformer_lung(nnFormerTrainer):
    """
    ...
    def initialize_network(self):
        ...
        self.network = UNETR_PP(in_channels=1, out_channels=2, img_size=self.crop_size, feature_size=16, num_heads=4,
        ...
        # self.network = UNETR_PP(in_channels=1, out_channels=2, img_size=(96, 96, 96), feature_size=16, num_heads=4,
        #                         norm_name = 'batch', depths = [3,3,3,3], dims = [32, 64, 128, 256], do_ds = False)
    ...
    def do_split(self):
        ...
        if self.fold == "all":
            ...
            splits[self.fold]['train'] = np.array([ 'lung053', 'lung022', 'lung041', 'lung069', 'lung014', 
                                                    'lung006', 'lung065', 'lung018', 'lung096', 'lung084',
                                                    'lung086', 'lung043', 'lung020', 'lung051', 'lung079', 
                                                    'lung004', 'lung075', 'lung016', 'lung071', 'lung028',
                                                    'lung055', 'lung036', 'lung047', 'lung059', 'lung061',
                                                    'lung010', 'lung073', 'lung026', 'lung038', 'lung045',
                                                    'lung034', 'lung049', 'lung057', 'lung080', 'lung092',
                                                    'lung015', 'lung064', 'lung031', 'lung023', 'lung005',
                                                    'lung078', 'lung066', 'lung009', 'lung074', 'lung042',
                                                    'lung033', 'lung095', 'lung037', 'lung054', 'lung029'
                                                  ])
                                                   
            splits[self.fold]['val'] = np.array([ 'lung058', 'lung025', 'lung046', 'lung070', 'lung001', 
                                                  'lung062', 'lung083', 'lung081', 'lung093', 'lung044', 
                                                  'lung027', 'lung048', 'lung003' ])
