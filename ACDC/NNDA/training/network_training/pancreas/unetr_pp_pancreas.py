...
from nnformer.training.network_training.pancreas.model_components import UnetrPPEncoder, UnetrUpBlock
import torch
...
class UNETR_PP(SegmentationNetwork):
    ...
    def __init__(
        ...
        # self.windowsizes = [(8,8,8),(4,4,4,),(2,2,2),(2,2,2)]
        self.windowsizes = [(4,4,4),(4,4,4,),(2,2,2),(2,2,2)]
...
# img_size = (64,128,128)
# # net = UNETR_PP(in_channels=1,out_channels=14,img_size = img_size)

# net = UNETR_PP(in_channels=1, out_channels=14, img_size=(64, 128, 128), feature_size=16, num_heads=4,
#                norm_name = 'batch', depths = [3, 3, 3, 3], dims = [32, 64, 128, 256], do_ds = True).to(device)
