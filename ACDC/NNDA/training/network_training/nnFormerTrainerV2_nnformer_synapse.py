...
from nnformer.training.network_training.synapse.unetr_pp_synapse  import UNETR_PP
...
class nnFormerTrainerV2_nnformer_synapse(nnFormerTrainer_synapse):
    ...
    def __init__(self, plans_file, fold, output_folder=None, dataset_directory=None, batch_dice=True, stage=None,
        ...
        # self.weight_decay = 3e-5  #这是我新增的，原来没有
    ...
    def initialize_network(self):
        ...
        self.network = UNETR_PP(in_channels=1, out_channels=14, img_size=(96, 96, 96), feature_size=16, num_heads=4,
                                norm_name = 'batch', depths = [3,3,3,3], dims = [32, 64, 128, 256], do_ds = True)
        # self.network = UNETR_PP(in_channels=1, out_channels=14, img_size=(64, 128, 128), feature_size=16, num_heads=4,
        #                         norm_name = 'batch', depths = [3,3,3,3], dims = [32, 64, 128, 256], do_ds = True)
        ...
        # # input = (torch.rand(1,1,64,128,128).cuda(),)
        # # input = torch.rand(1,1,64,128,128).cuda()
        ...
        # macs, params = get_model_complexity_info(self.network, (1,96, 96, 96), as_strings=True,print_per_layer_stat=False, verbose=True)
    ...
    def do_split(self):
        ...
        if self.fold == "all":
            ...
            splits[self.fold]['train']=np.array(['ABD_006','ABD_007' ,'ABD_009', 'ABD_010', 'ABD_021' ,'ABD_023' ,'ABD_024','ABD_026' ,'ABD_027' ,'ABD_031', 'ABD_033' ,'ABD_034' \
                                ,'ABD_039', 'ABD_040','ABD_005', 'ABD_028', 'ABD_030', 'ABD_037'])
            splits[self.fold]['val']=np.array(['ABD_001', 'ABD_002', 'ABD_003', 'ABD_004', 'ABD_008', 'ABD_022','ABD_025', 'ABD_029', 'ABD_032', 'ABD_035', 'ABD_036', 'ABD_038'])
            ...
            if self.fold < len(splits):
                ...
                rnd = np.random.RandomState(seed=3407 + self.fold)
