...
from nnformer.training.network_training.acdc.nnda_unetr  import NNDA_UNETR
...
class nnFormerTrainerV2_nnformer_acdc(nnFormerTrainer):
    ...
    def initialize(self, training=True, force_load_plans=False):
        ...
        if not self.was_initialized:
            ...
            # assert isinstance(self.network, (SegmentationNetwork, nn.DataParallel)) #这原本没有注释
        else:
    ...
    def initialize_network(self):
        ...
        self.network = NNDA_UNETR(in_channels=1, out_channels=4, img_size=self.crop_size, feature_size=16, num_heads=4,
        ...
        macs, params = get_model_complexity_info(self.network, (1,16, 160, 160), as_strings=True,
    ...
    def initialize_optimizer_and_scheduler(self):
        # assert self.network is not None, "self.initialize_network must be called first" #这也是我注释掉的
