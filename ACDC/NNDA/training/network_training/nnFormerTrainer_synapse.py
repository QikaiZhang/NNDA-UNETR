...
class nnFormerTrainer_synapse(NetworkTrainer):
    ...
    def initialize(self, training=True, force_load_plans=False):
        ...
        # assert isinstance(self.network, (SegmentationNetwork, nn.DataParallel)) #原本没注释，然后我自己注释 但是好像现在这里报错
    ...
    def predict_preprocessed_data_return_seg_and_softmax(self, data: np.ndarray, do_mirroring: bool = True,
        ...
        # assert isinstance(self.network, tuple(valid)) #原本没注释，然后我自己注释 但是好像现在这里报错
