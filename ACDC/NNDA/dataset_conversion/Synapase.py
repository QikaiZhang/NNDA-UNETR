...
if __name__ == "__main__":
    ...
    base = "/home/zqk/BTCV/model_test/SwinUNetR/ACDC/nnFormer-main/DATASET/nnFormer_raw/nnFormer_raw_data/RawData/"
    ...
    train_folder = join(base, "Training/imagesTr")
    label_folder = join(base, "Training/labelsTr")
