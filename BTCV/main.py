...
from optimizers.lion_optimizer import Lion
...
def main_worker(gpu, args):
    ...
    if args.use_ssl_pretrained:
        try:
            ...
            #--------------------------
            #             #冻结指定的权重
            freeze_keys = ['encoder', 'swin','out','decoder']  # 需要冻结的关键字列表
    ...
    elif args.optim_name == "Lion":
        optimizer = Lion(model.parameters(), lr=args.optim_lr,weight_decay=args.reg_weight)
